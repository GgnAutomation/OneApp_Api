...
public class BaseClass {
	...
	public static  String getPropertyFileValue(String key) throws FileNotFoundException, IOException {
		...
		properties.load(new FileInputStream(
				"C:\\Users\\Welcome\\eclipse-workspace\\OneApp\\src\\test\\resources\\PropertyFile\\config.properties"));
		Object object = properties.get(key);
		return (String) object;

	}

	public static String getPropertyFileValue1(String key) throws FileNotFoundException, IOException {

		Properties properties = new Properties();
		properties.load(new FileInputStream(
				"C:\\Users\\Welcome\\eclipse-workspace\\OneApp\\src\\test\\resources\\PropertyFile\\configformdata.properties"));
		Object object = properties.get(key);
		return (String) object;

...
public class Tc_5_Upload_Profile_Pic_One_App extends BaseClass {

	PayloadManager payloadManager = new PayloadManager();

	@Given("the login API is available and user add headers for Upload_Profile_Pic")
	public void the_login_api_is_available_and_user_add_headers_for_upload_profile_pic() {
	...
	@When("user add requestBody for validLogin loginId {string} ,loginType {string}  and notificationType {string} for Upload_Profile_Pic")
	public void user_add_request_body_for_valid_login_login_id_login_type_and_notification_type_for_upload_profile_pic(
	...
	@When("the user sends a ExternalLogin request with {string} for Upload_Profile_Pic")
	public void the_user_sends_a_external_login_request_with_for_upload_profile_pic(String post)
			throws FileNotFoundException, IOException {
		addReqType(post, getPropertyFileValue("Login"));
	}

	@Then("the response status should be {int} and message {string} and loginId {string} for Upload_Profile_Pic")
	public void the_response_status_should_be_and_message_and_login_id_for_upload_profile_pic(int expectedResponseCode,
	...
	@When("user add request for otpLogin Endpoint along with loginId {string} , isdCode {string} ,deviceType {string} ,osVersion {string} ,appVersion {string} and deviceModel {string} for Upload_Profile_Pic")
	public void user_add_request_for_otp_login_endpoint_along_with_login_id_isd_code_device_type_os_version_app_version_and_device_model_for_upload_profile_pic(
	...
	@When("the user sends a valid Login Otp request with {string} for Upload_Profile_Pic")
	public void the_user_sends_a_valid_login_otp_request_with_for_upload_profile_pic(String post)
			throws FileNotFoundException, IOException {
		addReqType(post, getPropertyFileValue("LoginOtp"));
		
	}

	@Then("Validate the OTP Generated having the response code as {int} and verify message {string} , loginId {string} , firstName {string} , lastName {string} , appName {string} and primaryUser {string} for Upload_Profile_Pic")
	public void validate_the_otp_generated_having_the_response_code_as_and_verify_message_login_id_first_name_last_name_app_name_and_primary_user_for_upload_profile_pic(
	...
	public void the_login_api_is_available_and_add_headers_for_upload_profile_pic() throws FileNotFoundException, IOException {
		RestAssured.registerParser("text/plain", Parser.JSON);
		List<Header> list_headers = new ArrayList<>();
		Header h1 = new Header("appid", "External");
		Header h2 = new Header("specificAppId", "OneApp");
	...
	@When("user add requestBody with extension {string},customerID {string} ,vinID {string} ,documentIdentifier {string} ,category {string} ,subCategory {string} ,emergencyId {string} for Upload_Profile_Pic")
	public void user_add_request_body_with_extension_customer_id_vin_id_document_identifier_category_sub_category_emergency_id_for_upload_profile_pic(
		...
		ExtentCucumberAdapter.getCurrentStep().log(Status.INFO,
				"Upload Profile pic URL is: " + getPropertyFileValue("UploadDocument"));
		ExtentCucumberAdapter.getCurrentStep().log(Status.INFO,
	...
	@When("the user sends a request with {string} for Upload_Profile_Pic")
	public void the_user_sends_a_request_with_for_upload_profile_pic(String post)
			throws FileNotFoundException, IOException {
		addReqType(post, getPropertyFileValue("UploadDocument"));
	}

	@Then("the response status for Upload_Profile_Pic should be {int} ,message {string} ,successMsg {string} and status {string}")
	public void the_response_status_for_upload_profile_pic_should_be_message_success_msg_and_status(int expResponseCode,
			String expMessage, String expSucessMessage, String expStatus) {
		System.out.println(getResBodyAsPrettyString());
		ExtentCucumberAdapter.getCurrentStep().log(Status.INFO, "Response Status code is: " + getResponseCode());
		ExtentCucumberAdapter.getCurrentStep().log(Status.INFO, "Response Generated is: " + getbody().asPrettyString());
		Upload_Profile_Pic_Root_Output root_Output = getbody().as(Upload_Profile_Pic_Root_Output.class);
		...
		assertEquals(expSucessMessage, root_Output.data.message, "verify SuccessMessage");
		assertEquals(expStatus, root_Output.data.status, "verify status");
	}
//<----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->

	@When("user add requestBody with PNGextension {string},customerID {string} ,vinID {string} ,documentIdentifier {string} ,category {string} ,subCategory {string} ,emergencyId {string} for Upload_Profile_Pic")
	public void user_add_request_body_with_pn_gextension_customer_id_vin_id_document_identifier_category_sub_category_emergency_id_for_upload_profile_pic(
			String extension, String customerID, String vinID, String documentIdentifier, String category,
			String subCategory, String emergencyId) throws FileNotFoundException, IOException {
...
//<------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
	@When("user add requestBody with JPEGextension {string},customerID {string} ,vinID {string} ,documentIdentifier {string} ,category {string} ,subCategory {string} ,emergencyId {string} for Upload_Profile_Pic")
	public void user_add_request_body_with_jpe_gextension_customer_id_vin_id_document_identifier_category_sub_category_emergency_id_for_upload_profile_pic(
			String extension, String customerID, String vinID, String documentIdentifier, String category,
			String subCategory, String emergencyId) throws FileNotFoundException, IOException {
	...
	public void the_login_api_is_available_and_add_headers_with_blank_token_for_upload_profile_pic() {
		RestAssured.registerParser("text/plain", Parser.JSON);
		List<Header> list_headers = new ArrayList<>();
		Header h1 = new Header("appid", "External");
	...
	@Then("the response status for Upload_Profile_Pic should be {int} ,message {string} ,errorCode {int} and errorDescription {string}")
	public void the_response_status_for_upload_profile_pic_should_be_message_error_code_and_error_description(int expResponseCode, String expMessage, int experrorCode, String expErrorDescription) {
		System.out.println(getResBodyAsPrettyString());
		ExtentCucumberAdapter.getCurrentStep().log(Status.INFO, "Response Status code is: " + getResponseCode());
		ExtentCucumberAdapter.getCurrentStep().log(Status.INFO, "Response Generated is: " + getbody().asPrettyString());
	...
	public void the_login_api_is_available_and_adding_headers_for_upload_profile_pic()
			throws FileNotFoundException, IOException {
		RestAssured.registerParser("text/plain", Parser.JSON);
		List<Header> list_headers = new ArrayList<>();
		Header h1 = new Header("appid", "External");
	...
	@When("the user sends a request with {string} and invalid url {string} for Upload_Profile_Pic")
	public void the_user_sends_a_request_with_and_invalid_url_for_upload_profile_pic(String post, String url) {
		addReqType(post, url);
	}

	@Then("the response status for Upload_Profile_Pic should be {int} ,message {string} and errorCode {string}")
	public void the_response_status_for_upload_profile_pic_should_be_message_and_error_code(int expResponseCode,
	...
	// <---------------------------------------------------------------------------------------------------------------------------------------------------------------------->
	@Then("the response status in Upload_Profile_Pic for empty request body should be {int}")
	public void the_response_status_in_upload_profile_pic_for_empty_request_body_should_be(int expResponseCode) {

...
public class DealerDetail {
	...
	public String dealerDisplayName;

	public DealerDetail() {
	}

	public DealerDetail(String dealerCode, String dealerName, String areaOffice, String zonalOffice,
			String dealerMobileNo, String dealerMail, String addressline1, String addressline2, String city,
			...
			ArrayList<AsmService> asmService, ArrayList<DivDetail> divDetails, ArrayList<RmTct> rmTct, String brandName,
